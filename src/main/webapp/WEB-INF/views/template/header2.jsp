...
<div class="container">
    ...
    <nav class="navbar navbar-inverse bs-dark">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" style="color:#ffffff" href="http://aizant.com/">AIZANT CASE REPORT APPLICATION</a>
        </div>

        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav" width="100px">
            <li><a href="/AizantCaseReportApplication/" style="color:#ffffff">HOME</a></li>
            <li class="dropdown">
