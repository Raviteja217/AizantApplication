...
<div class="container">
    ...
    <nav class="navbar navbar-inverse bs-dark">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" style="color:#ffffff" href="http://aizant.com/">AIZANT CASE REPORT APPLICAION</a>
        </div>

        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav" width="100px">
          <sec:authorize access="hasRole('ROLE_ADMIN')">
            <li><a href="Admin" style="color:#ffffff" target="_self">HOME</a></li>
            </sec:authorize> 
            <sec:authorize access="hasRole('ROLE_MONITOR/QA')">
            <li><a href="/AizantCaseReportApplication/Subject_Form" style="color:#ffffff" target="_self">HOME</a></li>
            </sec:authorize>
            <li class="dropdown">
