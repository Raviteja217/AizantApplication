...
<script
	src="<%=request.getContextPath()%>/resources/js/edit_AZ_Form_3.js" /></script>
...
<body ng-app="editApp" ng-controller="edit_AZ_Form3Ctrl">
	<div class="allbody" >
		<div>
		...
		<hr>
	 	  ...
	 	  <div id="container" style="width: 100%;">
			<div id="leftContainer">CRF No. :<input type="text" ng-init="AZ_Form_3.crfNo='${mainReport.crfNo }'" ng-model="AZ_Form_3.crfNo" disabled></div>
			<div align="center" style="width: 67%">Project No.:&emsp;<input type="text" ng-init="AZ_Form_3.projectNo='${mainReport.projectNo}'" ng-model="AZ_Form_3.projectNo" disabled></div>
			<br>

			<div id="left" style="float: left; width: 33%;">
				Registration No.: &emsp;<input type="text" ng-init="AZ_Form_3.registrationNo='${mainReport.registrationNo }'" ng-model="AZ_Form_3.registrationNo" disabled>
			</div>
			<div id="left" style="float: left; width: 33%;">
				Period No.: &emsp;<input type="text" ng-init="AZ_Form_3.periodNo='${mainReport.periodNo}'" ng-model="AZ_Form_3.periodNo" disabled>
				
			</div>
			<div align="right" style="float: right; width: 33%;">
				Subject No.: &emsp;<input type="text" ng-init="AZ_Form_3.subjectNo='${mainReport.subjectNo }'" ng-model="AZ_Form_3.subjectNo" disabled>
			</div> 
		...
		<b>A. </b> <b>Is the subject verified for Volunteer Cross
			Participation?</b> &emsp;&emsp; &emsp;&emsp;&emsp;&emsp;<select ng-model="AZ_Form_3.a" path="a">
		...
		&emsp;&emsp;&emsp;&emsp; &emsp;&emsp; &emsp;<select ng-model="AZ_Form_3.b" path="b">
			<option value="YES">YES</option>
			<option value="NO">NO</option>
		...
		<table style="width: 100%">
			<tr>
				...
				<td><select ng-model="AZ_Form_3.c_1" path="c_1" required>
						<option value="YES">YES</option>
						<option value="NO">NO</option>
			...
			<tr>
				...
				<td><select ng-model="AZ_Form_3.c_2" path="c_2">
						<option value="YES">YES</option>
						<option value="NO">NO</option>
			...
			<tr>
				...
				<td><select ng-model="AZ_Form_3.c_3" path="c_3">
						<option value="YES">YES</option>
						<option value="NO">NO</option>
			...
			<tr>
				...
				<td><select ng-model="AZ_Form_3.c_4" path="c_4">
						<option value="YES">YES</option>
						<option value="NO">NO</option>
			...
			<tr>
				...
				<td><select ng-model="AZ_Form_3.c_5" path="c_5">
						<option value="YES">YES</option>
						<option value="NO">NO</option>
			...
			<tr>
				...
				<td><select ng-model="AZ_Form_3.c_6" path="c_6">
						<option value="YES">YES</option>
						<option value="NO">NO</option>
			...
			<tr>
				...
				<td><select ng-model="AZ_Form_3.c_7" path="c_7">
						<option value="YES">YES</option>
						<option value="NO">NO</option>
		...
		<table style="width: 100%">
			<tr>
				...
				<td><select ng-model="AZ_Form_3.restriction_compliance" path="restriction_compliance">
						<option value="YES">YES</option>
						<option value="NO">NO</option>
		...
		<br>
		<p>Comments:</p>
		<textarea rows="5" cols="175" ng-model="AZ_Form_3.comments" path="comments">
</textarea>
<%=this.getClass().getSimpleName().replaceFirst(".jsp"," ")%>
<%request.getAttribute("ClassName"); %>
		<br>
		<div align="left">
			<br> &emsp;Recorded by : <input type="text" ng-model="AZ_Form_3.recorded_By" path="Recorded_By"
		...
		<div align="right">
			<br> &emsp;Reviewed by : <input type="text" ng-model="AZ_Form_3.reviewed_By" path="Reviewed_By" placeholder="Enter pin here"><!-- <a href="pin_user?pin={{pin}}">OK</a> --><br>(Sign & Date) <br>
		<!-- <input type="hidden" ng-model="AZ_Form_3.dt" path="dt" /> -->
		</div>
