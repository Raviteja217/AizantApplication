...
<form>
		...
		<hr>
	 	  ...
	 	  <div id="container" style="width: 100%;">
			<div id="leftContainer">CRF No. :<input type="text"  value="${form3.crfNo }" style="width:65px" readonly/></div>
			<div align="center" style="width: 67%">Project No.:&emsp;<input type="text" value="${form3.projectNo}" style="width:65px" readonly/></div>
			<br>

			<div id="left" style="float: left; width: 33%;">
				Registration No.: &emsp;<input type="text" value="${form3.registrationNo }" style="width:65px" readonly/>
			</div>
			<div id="left" style="float: left; width: 33%;">
				Period No.: &emsp;<input type="text" value="${form3.periodNo}" style="width:35px" readonly/>
			</div>
			<div align="right" style="float: right; width: 33%;">
				Subject No.: &emsp;<input type="text" value="${form3.subjectNo }" style="width:35px" readonly/>
			</div> 
		...
		<b>A. </b> <b>Is the subject verified for Volunteer Cross
			Participation?</b> &emsp;&emsp; &emsp;&emsp;&emsp;&emsp;<input type="text" value="${form3.a }" style="width:35px" readonly/>
		 <br> (applicable for period-1) <br> <br> <b>B.</b> <b>
			Is the subject eligible to participate in the study?</b> &emsp;&emsp;
		&emsp;&emsp;&emsp;&emsp; &emsp;&emsp; &emsp;<input type="text" value="${form3.b }" style="width:35px" readonly/> <br> <br> <b>C.</b> <b><u>RESTRICTION COMPLIANCE</u> </b> <br>
		<br>
		...
		<table style="width: 100%">
			<tr>
				...
				<td><input type="text" value="${form3.c_1 }" style="width:35px" readonly/></td>
			</tr>
			<tr>
				...
				<td><input type="text" value="${form3.c_2 }" style="width:35px" readonly/></td>
			...
			<tr>
				...
				<td><input type="text" value="${form3.c_3 }" style="width:35px" readonly/></td>
			</tr>
			<tr>
				...
				<td><input type="text" value="${form3.c_4 }" style="width:35px" readonly/></td>
			...
			<tr>
				...
				<td><input type="text" value="${form3.c_5 }" style="width:35px" readonly/></td>
			</tr>
			<tr>
				<td>6. Have you participated in any drug research study within
					past 90 days / since previous period check-out?</td>
				<td><input type="text" value="${form3.c_6 }" style="width:35px" readonly/></td>

			</tr>
			<tr>
				<td>7. Have you donated blood within past 90 days / since
					previous period check-out??</td>
				<td><input type="text" value="${form3.c_7 }" style="width:35px" readonly/></td>
		...
		<table style="width: 100%">
			<tr>
				...
				<td><input type="text" value="${form3.restriction_compliance }" style="width:35px" readonly/></td>

			</tr>
		</table>
		<br>
		<p>Comments:</p>
		<textarea rows="5" cols="175" readonly>${form3.comments}</textarea>
		<br>
		<div align="left">
			<br> &emsp;Recorded by : <input type="text" value="${form3.recorded_By}" style="width:50px" readonly/><!-- <a href="pin_user?pin={{pin}}">OK</a> --><br>(Sign & Date) <br>
		</div>
		<br>
		...
		<div align="right">
			<br> &emsp;Reviewed by : <input type="text" value="${form3.reviewed_By}" style="width:50px" readonly/><!-- <a href="pin_user?pin={{pin}}">OK</a> --><br>(Sign & Date) <br>
		</div>
