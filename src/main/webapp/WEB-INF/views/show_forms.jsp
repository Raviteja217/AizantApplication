...
<%@ include file="/WEB-INF/views/template/header.jsp"%>
	...
	<div ng-app="myApp" ng-controller="formsCtrl">
		...
		toppad">
				<div class="panel panel-info">
					<div class="panel-heading">
						...
						<div class="panel-title"><b> View Forms</b></div>
						</span>
					...
					<div class="panel-body">
						<div>
							...
							<table class="table table-hover table-bordered">
								...
								<tr ng-repeat="f in allforms | filter:searchBy">
								<td>{{$index+1}}</td>
									<td>{{f.forms}}</td>
      ...
      <a
										...
										href="${pageContext.servletContext.contextPath}/deletecrf?id={{c.id}}"><span
