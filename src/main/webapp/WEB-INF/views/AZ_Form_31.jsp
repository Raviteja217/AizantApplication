...
<form ng-submit="AZ_Form3()">
		...
		<hr>
	 	  ...
	 	  <div id="container" style="width: 100%;">
			<div id="leftContainer">CRF No. :<input type="text" value="${mainReport.crfNo }" path="crfNo"></div>
			<div align="center" style="width: 67%">Project No.:<input type="text" value="${mainReport.projectNo}"></div>
			<br>

			<div id="left" style="float: left; width: 33%;">
				Registration No.: &emsp;<input type="text" value="${mainReport.registrationNo }">
			</div>
			<div id="left" style="float: left; width: 33%;">
				Period No.: &emsp;<input type="text" value="${mainReport.periodNo}">
			</div>
			<div align="right" style="float: right; width: 33%;">
				Subject No.: &emsp;<input type="text" value="${mainReport.subjectNo }">
			</div> 
		...
		<br>
		<p>Comments:</p>
		<textarea rows="5" cols="175" ng-model="AZ_Form_3.comments">
</textarea>
		<br>
		<div align="left">
			<br> &emsp;Recorded by : <input type="text" ng-model="AZ_Form_3.Recorded_By"
		...
		<div align="right">
			<br> &emsp;Reviewed by : <input type="text" ng-model="AZ_Form_3.Reviewed_By" placeholder="Enter pin here"><!-- <a href="pin_user?pin={{pin}}">OK</a> --><br>(Sign & Date) <br>
		</div>
