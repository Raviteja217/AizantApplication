...
<%@ include file="/WEB-INF/views/template/header.jsp"%>
	...
	<div
		class="col-xs-7 col-sm-7 col-md-5 col-lg-5
		...
		<div class="panel panel-info">
			<div class="panel-heading">
				<h3 class="panel-title"><b>View CRF</b></h3>
			</div>
					...
					<div>
						<table class="table table-hover table-bordered">
							<tbody>
								...
								<tr>
									<td>ProjectNumber:</td>
									<td>${crfNumber.project_Number}</td>
								</tr>
								<tr>
									<td>CRF Number</td>
									<td>${crfNumber.crf_Number}</td>
								</tr>
						...
						<%-- <a href="edit_crf?id=${crfNumber.id}" class="btn btn-primary">EDIT</a> --%>
					</div>
				</div>
			</div>
		</div>
            ...
            <div class="well well-sm">
                <div class="row">
                    <div class="col-sm-6 col-md-4">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQxujXw33bsWlDMIitUJgYE0hZ2tTf8YoEgEliVbxW6ka8rIM43" alt="" class="img-rounded img-responsive" />
                    </div>
                    <div class="col-sm-6 col-md-8">
                        ...
                        <p>
                            ...
                            <br />
                            <i class="glyphicon glyphicon-star"></i>${user.pin}
                            <br />
				...
				<td rowspan="8"><img
					src='<x:url value="/resources/images/${user.image}"/>' /></td>
                        ...
                        <!-- Split button -->
                        <div align="right">
                       	<a href="change_password?id=${user.id}" class="btn btn-primary">Change Password</a></div>
                    </div>
                </div>
            </div>
        </div>
