		...
		toppad">
				<div class="panel panel-info">
					<div class="panel-heading">
						...
						<div class="panel-title"><b>Users & Details</b></div>
						</span>
					...
					<div class="panel-body">
							...
							<table class="table table-hover table-bordered">
								...
								<tr ng-repeat="s in names | filter:searchBy">
									...
									access="hasRole('ROLE_ADMIN')"> --%> <a
										...
										href="${pageContext.servletContext.contextPath}/deleteuser?id={{s.id}}"><span
											class="glyphicon glyphicon-trash"></span></a> --%>
											<a ng-click="openDeleteModal(s.id,s.username)"><span
						...
						<div id="rightContainer">
							<a href="create_user"><span class="glyphicon glyphicon-plus"></span>click
								here to add User</a>
						</div>
