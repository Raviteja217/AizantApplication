...
<script
	src="<%=request.getContextPath()%>/resources/js/deletePrivileges.js" /></script>
...
<%@ include file="/WEB-INF/views/template/header.jsp"%>
	...
	<div ng-app="myApp" ng-controller="privilegersCtrl">
						...
						<div class="panel-body">
							<div>
								...
								<table class="table table-hover table-bordered">
									...
									<tr ng-repeat="p in details | filter:searchBy">
										<td>{{p.userName}}</td>
										<td>{{p.projectNo}}</td>
										<td>{{p.crfNo}}</td>
										<td>{{p.forms}}</td>
     ...
     --%> <a
											href="${pageContext.servletContext.contextPath}/edit_privileger?id={{p.id}}"><span
												class="glyphicon glyphicon-pencil"></span></a><%--  <a
											href="${pageContext.servletContext.contextPath}/deletePrivileger?id={{p.id}}"><span
												class="glyphicon glyphicon-trash"></span></a> --%>
												<a ng-click="openDeleteModal(p.id,p.userName,p.projectNo,p.crfNo,p.forms)"><span
